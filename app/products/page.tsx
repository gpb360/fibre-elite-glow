...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/lovable-uploads/webp/total-essential-fiber-supplement-bottle.webp',
        width: 1200,
        height: 630,
        alt: 'Total Essential Premium Fiber Collection - natural digestive health supplements'
      }
    ]
  },
  twitter: {
    ...
    images: ['/lovable-uploads/webp/total-essential-fiber-supplement-bottle.webp']
  }
};
