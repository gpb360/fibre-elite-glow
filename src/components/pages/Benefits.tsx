  ...
  <section className="relative overflow-hidden bg-white pt-20 pb-12 md:pt-32 md:pb-20">
    <div className="absolute inset-0 z-0 opacity-20">
      <Image
        ...
        priority={false} // Changed to false - not critical for LCP
        sizes="100vw"
      />
    </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_600px] lg:gap-12 xl:grid-cols-[1fr_700px]">
        <div className="flex flex-col justify-center space-y-4">
          ...
          <OptimizedMotion
            ...
            transition={{ duration: 0.12, delay: 0.08 }} // Optimized
          >
            <Link
          ...
          <OptimizedMotion
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.1, delay: 0.15 }} // Optimized
          >
...
// Memoized benefits data to prevent recreation
const benefitsData = [
  {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Lazy load the heavy benefits grid since it's below the fold */}
        <IntersectionLazy rootMargin="100px">
          <div className="container mx-auto px-4 py-12">
            ...
            {/* Optimized benefits grid with stagger animation */}
            <OptimizedMotion
            ...
            {/* Scientific evidence section - lazy loaded as well */}
