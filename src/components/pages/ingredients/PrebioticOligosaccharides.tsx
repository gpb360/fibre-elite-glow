...
import { Heart, Shield, Award, ArrowRight, Microscope, Leaf, BarChart3, Droplets, Brain, Check, Bacteria, Sparkles } from 'lucide-react';
...
const IngredientSchema = () => {
  const schemaData = {
    ...
    "name": "Prebiotic Oligosaccharides",
...
const PrebioticOligosaccharidesHero = () => (
        ...
        <div className="flex flex-col justify-center space-y-4">
          ...
          >
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
              Prebiotic Oligosaccharides<span className="text-green-500">.</span>
            </h1>
          ...
          >
            <div className="flex items-center">
              <Bacteria className="h-4 w-4 text-green-500 mr-1" />
...
const PrebioticOligosaccharides = () => {
  const benefits = [
    {
      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-green-50">
          <div className="container mx-auto px-4">
            <Heading 
              title="Types of Prebiotic Oligosaccharides" 
        ...
        <section id="benefits" className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <Heading 
              title="Health Benefits of Prebiotic Oligosaccharides" 
        ...
        <SplitSection
          ...
          title="How Prebiotic Oligosaccharides Work"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <Heading 
                ...
                description="Research supporting the benefits of Prebiotic Oligosaccharides" 
                centered 
                className="mb-8" 
              />
        ...
        <section className="py-16 bg-green-50">
          <div className="container mx-auto px-4">
            <Heading 
              ...
              description="Understanding the unique nutritional profile of Prebiotic Oligosaccharides" 
              centered 
              className="mb-12" 
            />
...
export default PrebioticOligosaccharides;
