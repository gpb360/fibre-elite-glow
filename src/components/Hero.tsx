...
export function Hero() {
  return (
    <section className="relative bg-green-50 pt-10 pb-10 md:pt-20 md:pb-20 overflow-hidden">
      {/* Background image for high-end feel - Optimized with lower priority */}
      <div className="absolute inset-0 z-0 opacity-20">
        <Image
          src="/lovable-uploads/webp/fruit-veg-bottle.webp"
          alt="Natural Canadian fiber supplement bottles surrounded by fresh fruits and vegetables - La Belle Vie premium wellness products for Canadian health"
          fill
          className="object-cover"
          priority={false} // Changed to false as it's not critical for LCP
          placeholder="blur"
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 items-center min-h-[500px]">
          <div className="flex flex-col justify-center space-y-8 text-left">
            ...
            <OptimizedMotion
              ...
              transition={{ duration: 0.12, delay: 0.08 }} // Optimized timing
            >
              <Link
            ...
            <OptimizedMotion
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.1, delay: 0.15 }} // Optimized timing
            >
